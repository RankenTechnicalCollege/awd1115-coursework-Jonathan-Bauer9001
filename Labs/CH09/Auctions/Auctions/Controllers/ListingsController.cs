...
namespace Auctions.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public ListingsController(IListingsService listingsService, IWebHostEnvironment webHostEnvironment, IBidsService bidsService, ICommentsServices commentsServices)
        {
        ...
        public async Task<IActionResult> Index(int? pageNumber, string searchString)
        {
            ...
            {
                applicationDbContext = applicationDbContext.Where(s => s.Title.Contains(searchString) || s.Description.Contains(searchString));
        ...
        public async Task<IActionResult> Create(ListingViewModel listing)
        {
            if(listing.Image != null)
            {
                ...
                string uniqueFileName = listing.Image.FileName;
        ...
        [HttpPost]
        public async Task<ActionResult> AddBid([Bind("Id,Amount,ListingId,IdentityUserId")] Bid bid)
        {
        ...
        public async Task<ActionResult> AddComment([Bind("Id,Content,ListingId,IdentityUserId")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                await _commentsServices.Add(comment);
            }
