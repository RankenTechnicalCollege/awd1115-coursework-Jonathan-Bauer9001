        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 3, "0800", 103, 1, "Intro to MERN" },
                    { 4, 4, "0900", 104, 1, "Intro to .NET MVC Core" },
                    { 5, 5, "0900", 105, 2, "Intro to Desktop Support" },
                    { 6, 1, "1000", 200, 3, "Advanced C#" },
                    { 7, 2, "1000", 201, 4, "Advanced Web Dev" },
                    { 8, 3, "1100", 203, 5, "Advanced MERN" }
                });
