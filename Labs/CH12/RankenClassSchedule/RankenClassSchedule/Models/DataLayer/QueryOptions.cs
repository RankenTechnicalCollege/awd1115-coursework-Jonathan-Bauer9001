...
namespace RankenClassSchedule.Models.DataLayer
{
    public class QueryOptions<T>
    {
        ...
        // public wrtie-only property for include statements - converts string to array
        public string Includes
        {
            set => includes = value.Replace(" ", "").Split(',');
        }

        // public get method for include statements - returns private string array or empty array
